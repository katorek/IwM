...
public class Bresenham
{
    ...
    public List<Point> findLine(int[][] grid, int x0, int y0, int x1, int y1)
    {
...
//        System.err.println("dx: "+dx + ", dy: "+dy +", sx: "+sx+", sy");
    ...
    public List<Point> findLine(int[][] arr, Point p1, Point p2) {
        System.err.println("p1: "+ p1.toString()+", p2: "+p2.toString());
        return findLine(arr, p1.x, p1.y, p2.x, p2.y);
    }
